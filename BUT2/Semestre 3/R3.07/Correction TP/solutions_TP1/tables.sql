...
DROP TABLE Appartient CASCADE CONSTRAINT;
DROP TABLE Operation CASCADE CONSTRAINT; 
DROP TABLE Compte CASCADE CONSTRAINT; 
DROP TABLE Client CASCADE CONSTRAINT; 
-- ALTER TABLE Agent DROP CONSTRAINT NN_SONAGENCE; 
-- ALTER TABLE Agence DROP CONSTRAINT NN_SONDIRECTEUR;
-- ALTER TABLE Agent DROP CONSTRAINT fk_Agent_Agence; --Si pas de CASCADE CONSTRAINT
-- ALTER TABLE Agent DROP CONSTRAINT fk_Agence_Agent;
