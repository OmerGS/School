...
CREATE TABLE Client (
    ...
    CONSTRAINT fk_Client_Compte FOREIGN KEY (compte) REFERENCES Compte(numCompte)
);

CREATE TABLE Appartient (
    unCompte INT,
    unClient INT,
    CONSTRAINT fk_compte FOREIGN KEY (unCompte) REFERENCES Compte(numCompte),
    CONSTRAINT fk_client FOREIGN KEY (unClient) REFERENCES Client(numClient),
