...
UPDATE Agent SET salaire = 4800 WHERE numAgent = 1; -- Pas inséré, le salaire augmente de plus de 10% ;
...
UPDATE Agent SET salaire = 4800 WHERE numAgent = 1 ;
...
select solde from Compte where numCompte=1; -- Solde = 50
...
select solde from Compte where numCompte=1;  -- solde mis à jour à 0;
INSERT INTO Operation(numOperation,typeOperation,montant,leclient,leCompte) VALUES (112,'DEPOT',500,1,1);
select solde from Compte where numCompte=1; -- solde mis à jour à 500;
