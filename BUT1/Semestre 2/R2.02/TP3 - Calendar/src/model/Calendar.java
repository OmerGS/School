...
/**
* Utility class that provides operations to handle dates, using the java.util.Calendar
* methods
*
...
public class Calendar
{
    ...
    */
    public void previousDay()
    {
        ...
        //this.calendar.get(java.util.Calendar.DAY_OF_MONTH) + "/" + this.calendar.get(java.util.Calendar.MONTH));
    }
