...
public class ScenarioPromotion2 {
    ...
    static Promotion2 but1;
    static Promotion2 but2;
    static Promotion2 but3;

    public static void main(String[] args) {
        but1 = new Promotion2("but1info", creationTableauEtudiant());
        but2 = new Promotion2("but2info", creationTableauEtudiant());
        but3 = new Promotion2("but3info", creationTableauEtudiant());
...
// ! ----------------------------------------------------------
    ...
    public static void testConstructeur(){
        ...
        //Cas Erreur
        promo = new Promotion2("nom", liste);
        ...
        //Cas Erreur
        promo = new Promotion2(null, liste);
        testCasConstructeur(promo, liste);
        ...
        //Cas Normal
        promo = new Promotion2("but1", liste);
        testCasConstructeur(promo, liste);
    }

    private static void testCasConstructeur(Promotion2 promo, Etudiant[] liste) {
        boolean toutOk = true;
        if (liste == null) {
    ...
    private static void testCasGetNom(Promotion2 promo, String nom){
    ...
    public static void testSetNom(){
        ...
        System.out.println("Test n1 : Cas Normal !");
        promo = new Promotion2(ancienNom, liste);
    ...
    private static void testCasSetNom(Promotion2 promo, String ancienNom, String nouveauNom){
    ...
    public static Etudiant[] creationTableauEtudiant(){
        ...
        for(int i = 0; i < (listeEtudiantBut1.length)/2; i++){
