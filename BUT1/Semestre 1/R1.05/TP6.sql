...
/* --- Alg�bre Relationnel --- */
/*
film(anneeSortie = 2017 AND anneSorti <= 2019)[titre]
*/
...
/* --- Alg�bre Relationnel --- */
/*
(Personne[idPersonne = leRealisateur]film) UNION (Personne[idPersonne = unActeur]Acteur)
*/
...
/* --- Alg�bre Relationnel --- */
/*
(Film[Realisateur = idPersonne AND pays='JAPON']titre)
*/
...
/* --- Alg�bre Relationnel --- */
/*
(Film[Realisateur = idPersonne AND pays='JAPON']titre) UNION  (titre[anneeSortie <= 2020 AND anneeSortie >= 2014]titre)
*/
...
/* --- Alg�bre Relationnel --- */
/*
titre,anneeSortie​(σleRealisateur=idPersonne∧nom=′Besson′∧prenom=′Luc′(Film⋈leRealisateur=idPersonne​Personne))
*/

/* --- SQL --- */
SELECT titre, anneeSortie
FROM Film
WHERE leRealisateur = (SELECT idPersonne FROM Personne WHERE nom = 'Besson' AND prenom = 'Luc');
/*
...
/* --- Alg�bre Relationnel --- */
/*
Personne)−UPPER(nom),UPPER(prenom)(Personne idPersonne = leRealisateur)Film)
*/
...
FROM Personne P
JOIN Acteur A ON P.idPersonne = A.unActeur
WHERE A.cachet IS NOT NULL AND A.cachet < 10000;
/*
KurosawA	Akira
Neige	Blanche
Marceau	Sophie
...
/* --- Alg�bre Relationnel --- */
/*
(Personne, Film, Acteur[idPersonne = unActeur AND unFilm = code]nom, prenom)
*/
...
/*
Mon SQL Developpeur ne fonctionnait je n'ai pas reussi a faire cette question
*/
